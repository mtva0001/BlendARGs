...
output_file_path = os.path.join(folder_path, 'summary_RGI.csv')
...
output_file_path = os.path.join('RGI', 'gene_list.csv')
with open(output_file_path, 'w', newline='') as csvfile:
    writer = csv.writer(csvfile, delimiter=',')
    writer.writerow(['Gene'])
    writer.writerows([[gene] for gene in gene_list])

logging.info(f"Gene list saved to {output_file_path} successfully in the RGI folder.")
...
# Usage
csv_file = 'RGI/summary_RGI.csv'
hgt_files_folder = 'RGI'
